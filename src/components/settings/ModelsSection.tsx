...
import { Spinner, ErrorBanner, SuccessBanner } from './shared';
...
export function ModelsSection() {
  ...
  return (
    <div className="space-y-4">
      ...
      {showAddProvider && (
        <div className="p-4 rounded-xl bg-card border border-primary/20 space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {testing ? (
                <><Spinner /> {t('settings.providers.testing')}</>
              ) : (
          ...
          {testResult?.ok && (
            <SuccessBanner className="space-y-2">
              <div className="flex items-center gap-2">
      ...
      {/* Success Message */}
      {saveSuccess && (
        <SuccessBanner className="rounded-xl flex items-center gap-3">
                          ...
                          <div className="flex items-center justify-end gap-2 pt-3 border-t">
                            ...
                            >
                              {deletingProvider === providerId ? (
                                <><Spinner className="border-red-400" /> Deleting...</>
                              ) : (
