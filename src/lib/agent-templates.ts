...
const templates: LanguageTemplates = {
  en: { 'SOUL.md': enSoul, 'IDENTITY.md': enIdentity, 'USER.md': enUser, 'TOOLS.md': enTools, 'BOOTSTRAP.md': enBootstrap, 'AGENTS.md': enAgents },
  es: { 'SOUL.md': esSoul, 'IDENTITY.md': esIdentity, 'USER.md': esUser, 'TOOLS.md': esTools, 'BOOTSTRAP.md': esBootstrap, 'AGENTS.md': esAgents },
  fr: { 'SOUL.md': frSoul, 'IDENTITY.md': frIdentity, 'USER.md': frUser, 'TOOLS.md': frTools, 'BOOTSTRAP.md': frBootstrap, 'AGENTS.md': frAgents },
  de: { 'SOUL.md': deSoul, 'IDENTITY.md': deIdentity, 'USER.md': deUser, 'TOOLS.md': deTools, 'BOOTSTRAP.md': deBootstrap, 'AGENTS.md': deAgents },
};
