...
const defaultTheme: Theme = {
  ...
  light: {
    ...
    '--input': '220 13% 86%',
    '--ring': '211 100% 50%',
    '--sidebar-bg': '220 14% 94%',
    '--sidebar-fg': '220 13% 18%',
    '--sidebar-hover': '220 13% 89%',
...
const midnightTheme: Theme = {
  ...
  light: {
    ...
    '--input': '270 20% 84%',
    '--ring': '271 91% 60%',
    '--sidebar-bg': '272 30% 92%',
    '--sidebar-fg': '265 30% 15%',
    '--sidebar-hover': '270 25% 87%',
    '--sidebar-active': '271 91% 60%',
    '--sidebar-border': '270 20% 84%',
    '--success': '142 71% 45%',
    '--success-foreground': '0 0% 100%',
    '--warning': '38 92% 50%',
...
const silosTheme: Theme = {
  ...
  light: {
    ...
    '--input': '220 12% 86%',
    '--ring': '16 100% 60%',
    '--sidebar-bg': '220 12% 94%',
    '--sidebar-fg': '240 10% 10%',
    '--sidebar-hover': '220 12% 89%',
...
const roseTheme: Theme = {
  ...
  light: {
    ...
    '--input': '340 20% 84%',
    '--ring': '330 81% 60%',
    '--sidebar-bg': '342 22% 92%',
    '--sidebar-fg': '335 30% 12%',
    '--sidebar-hover': '340 20% 87%',
    '--sidebar-active': '330 81% 60%',
    '--sidebar-border': '340 20% 84%',
    '--success': '142 71% 45%',
    '--success-foreground': '0 0% 100%',
    '--warning': '38 92% 50%',
